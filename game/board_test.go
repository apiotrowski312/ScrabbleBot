...
func Test_collectAllUsedWords(t *testing.T) {
	...
	testBoard := board{
		...
		[]tile{tile{tileType: '0', letter: 's'}, tile{tileType: 'L'}, tile{tileType: '0'}, tile{tileType: 'L'}, tile{tileType: '0', letter: 's'}},
		[]tile{tile{tileType: 'W'}, tile{tileType: '0'}, tile{tileType: 'w'}, tile{tileType: '0'}, tile{tileType: 'W', letter: 'x'}},
	}

	expected := []string{"sdog.", "ssob.x"}
	words := testBoard.collectAllUsedWords("socks", [2]int{3, 0}, true)
